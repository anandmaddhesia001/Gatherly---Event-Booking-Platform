...
const users = [
    { name: 'Admin User', email: 'admin@Gatherly.com', password: 'password123', role: 'admin' },
    { name: 'Demo User', email: 'user@Gatherly.com', password: 'password123', role: 'user' },
    { name: 'Alice Smith', email: 'alice@Gatherly.com', password: 'password123', role: 'user' },
    { name: 'Bob Johnson', email: 'bob@Gatherly.com', password: 'password123', role: 'user' },
    { name: 'Charlie Dave', email: 'charlie@Gatherly.com', password: 'password123', role: 'user' },
    { name: 'Diana Prince', email: 'diana@Gatherly.com', password: 'password123', role: 'user' },
    { name: 'Ethan Hunt', email: 'ethan@Gatherly.com', password: 'password123', role: 'user' },
    { name: 'Fiona Gallagher', email: 'fiona@Gatherly.com', password: 'password123', role: 'user' },
    { name: 'George Miller', email: 'george@Gatherly.com', password: 'password123', role: 'user' },
    { name: 'Hannah Montana', email: 'hannah@Gatherly.com', password: 'password123', role: 'user' }
];
...
const seedDatabase = async () => {
    try {
        await mongoose.connect(process.env.MONGO_URI || 'mongodb://localhost:27017/Gatherly');
